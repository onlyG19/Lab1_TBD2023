    ...
    SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authManager) throws Exception{
        ...
        return http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(HttpMethod.GET, "/instituciones").permitAll()
                        .requestMatchers(HttpMethod.GET, "/emergencia/numeroTareasActivas/**").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/emergencia/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/emergencia/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/coordinadores").permitAll()
                        .requestMatchers(HttpMethod.GET, "/voluntarios").permitAll()
                        .requestMatchers(HttpMethod.POST, "/emergencia").permitAll()
                        .requestMatchers(HttpMethod.GET, "/emergencias").permitAll()
                        .requestMatchers(HttpMethod.POST, "/emergencia/voluntariosEnElRadio/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/ranking/listaRanking/**").permitAll()
